...
e.g. from Xen 4.21, ``5cc09cd03455^..06af9ef22996``::

  * 06af9ef22996 - (tag: RELEASE-4.21.0) Update to Xen 4.21
  * 7fba925b0358 - Config.mk Bump tags to final
  * 9c5c0730a9f4 - SUPPORT.md: Define support lifetime
  * 5cc09cd03455 - CHANGELOG.md: Set release date for 4.21
